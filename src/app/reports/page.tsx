...
type ReportsTab = "overview" | "customer-service";
...
function ReportsContent() {
  ...
  useEffect(() => {
    if (activeTab !== "customer-service") return;
  ...
  }, [activeTab, fetchSupportSubmissions]);
                    ...
                    {loading ? (
                      ...
                      filteredData.map((submission) => (
                        ...
                        >
                          ...
                          <TableCell className="text-muted-foreground">{submission.name}</TableCell>
                          <TableCell className="text-muted-foreground">{submission.email}</TableCell>
                          <TableCell className="text-muted-foreground">
                            {formatPhoneNumber(submission.phone)}
                          </TableCell>
                          <TableCell className="text-muted-foreground">
                            {submission.issueDescription ? truncate(submission.issueDescription, 90) : "—"}
                          </TableCell>
                                ...
                                <DropdownMenuItem
                                  onClick={() => {
                                    setSubmissionToShare({
                                      id: submission.id,
                                      type: submission.formType,
                                      name: submission.businessName || submission.name || "Submission",
                                    });
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{submissionToDelete?.name}</strong>? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
